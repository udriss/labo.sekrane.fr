// lib/hooks/usePhysicsCalendarEvents.ts

import { useCallback } from 'react'
import { CalendarEvent } from '@/types/calendar'

interface UsePhysicsCalendarEventsProps {
...
export const usePhysicsCalendarEvents = (calendarData: UsePhysicsCalendarEventsProps) => {
