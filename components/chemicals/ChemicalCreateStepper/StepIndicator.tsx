...
import { CheckCircle, Category, Details, Save } from '@mui/icons-material';
...
const steps = [
  { label: 'Preset ou saisie', icon: Category },
  { label: 'Détails & Localisation', icon: Details },
];
            ...
            <React.Fragment key={index}>
              ...
              >
                ...
                <Typography
                  variant="caption"
                  textAlign="center"
                  sx={{ maxWidth: 120, fontWeight: isActive ? 'bold' : 'normal' }}
                >
                  {step.label}
                </Typography>
              </Box>
