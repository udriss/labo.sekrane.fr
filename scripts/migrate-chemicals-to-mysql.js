    ...
    for (const chemical of chemicalsData.chemicals) {
      try {
        ...
        `, [
          ...
          chemical.purchaseDate || null,
          chemical.expirationDate || null,
          chemical.storage || null,
          chemical.room || null,
          chemical.hazardClass || null,
          chemical.supplierId || null,
          chemical.status || 'IN_STOCK',
          chemical.notes || null,
          chemical.quantityPrevision || chemical.quantity || 0,
          chemical.createdAt || new Date().toISOString(),
          chemical.updatedAt || new Date().toISOString()
        ]);
