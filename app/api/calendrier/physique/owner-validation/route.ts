// app/api/calendrier/physique/owner-validation/route.ts
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const isOwner = existingEvent.created_by === session.user.email || 
                   existingEvent.created_by === session.user.id
