...
export const POST = withAudit(
  async (request: NextRequest) => {
    try {
      ...
      // Mettre à jour actuelTimeSlots dans les notes
      // Note: il faudrait une fonction pour mettre à jour complètement les notes
      // Pour l'instant, on utilise updateTimeSlotInEvent qui fait partie du travail
      ...
      console.error('Erreur lors de l\'approbation du créneau physique:', error);
      return NextResponse.json(
