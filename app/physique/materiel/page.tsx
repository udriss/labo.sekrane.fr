// app/physique/materiel/page.tsx
  ...
  return (
    <Container maxWidth="xl" sx={{ py: 4 }}>
      ...
      <TabPanel value={tabValue} index={2}>
        ...
        {/* Boutons d'action pour la gestion - SUPPRIMÉ: Ajouter équipement */}
        <Box 
          sx={{ 
            display: 'flex', 
      ...
      {/* Dialog pour ajouter un équipement personnalisé aux catégories - SUPPRIMÉ */}
